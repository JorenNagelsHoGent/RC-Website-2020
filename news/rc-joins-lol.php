...
<head>
	...
	<title>Rocket Core Joins LoL</title>
...
<body>
	...
	<article id="rc_lol">
		<header>
			<img src="../img/posters/Posters-orginal/rc_lol.png">
			Rocket Core Joins League of Legends!
		</header>

		<div class="articleBody">
			<p>We are proud to announce that we have joined the League of Legends Esports scene! With 3 competitive teams and multiple community teams Rocket Core will be expanding in the League of Legends universe!</p>
		</div>
	</article>
