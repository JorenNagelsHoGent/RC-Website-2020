...
<head>
	...
	<title>The Elemental Series</title>
...
<body>
	...
	<article id="rc_lol">
		<header>
			...
			<img src="../img/posters//Posters-orginal/es.png">
			The Elemental Series
		</header>

		<div class="articleBody">
			<p>4 elements with complete disorder brought into control by one common focus; The Elemental Series. Each element has their own background and story, all with their own characteristics, finally culminating into the championship title for their chosen element. </p>
			<p>With a total prize pool of €3000 sponsored by <a href="https://challengermode.com">Challengermode.com</a> the top tier teams of the Rocket League scene will compete for the title!</p>
