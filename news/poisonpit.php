...
<body>
	...
	<article id="rc_lol">
		<header>
			...
			<img src="../img/posters/Posters-orginal/poisonpit.png">
			The Poison Pit!
		</header>

		<div class="articleBody">
			<p>Welcome to the Poison Pit! Each Thursday a 1V1 tournament for 8 weeks each season! After the season the top 4 players with the most Venom Points wins their share of €200!</p>
