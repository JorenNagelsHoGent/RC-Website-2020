	...
	<ul>
		...
		<li><a clas="teams" <?php if ($thisPage == "Teams")
			...
			<div class="teams-menu">
				<div class="game"><img src="./img/RL-emoji.png" alt="RL" width="40px"><a href="/teams/lol-teams.php">Rocket League</a></div>
				<div class="game"><img src="./img/LOL-emoji.png" alt="LOL" width="40px"><a href="/teams/rl-teams.php">League of Legends</a></div>
			</div>
		</li>
